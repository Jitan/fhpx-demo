...
public class FragmentHelper {
  ...
  public static void setupFragments(AppCompatActivity activity, Bundle savedInstanceState) {
    ...
    if (savedInstanceState != null) {
      ...
      mPhotoDetailFragment =
          (PhotoDetailFragment) mFragmentManager.findFragmentByTag(PHOTO_DETAIL_FRAGMENT_TAG);
  ...
  public static void showGridFragment() {
    mActionBar.show();
    mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
    mFragmentManager.beginTransaction().hide(mPhotoDetailFragment).show(mGridFragment).commit();
  }
